.. note::
   ...
   This directory contains the preliminary single-link prototype. The final
   RTLS implementation uses ``channel_sounding_ras_anchor`` and
   ``channel_sounding_ras_tag``.
