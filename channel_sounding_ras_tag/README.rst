Bluetooth Channel Sounding Multi-Link RTLS Tag
##############################################

This application implements the final mobile RTLS tag. It operates as a
Channel Sounding reflector and accepts up to three simultaneous connections
from Anchor 0, Anchor 1, and Anchor 2. Connectable advertising is restarted
after each connection until all three anchor slots are occupied.
